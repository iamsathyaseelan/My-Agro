...
<html>
	...
	<body>
		...
		<div id="mySidenav" class="sidenav">
			...
			<a href="index.php"><i class="glyphicon glyphicon-shopping-cart"></i>&nbsp;E-commerce</a>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<?php
							include('../db/db.php');
							$pid=$_GET['pid'];
							$sql_res=mysql_query("select * from products where id=$pid");
									...
									<div class="col-md-9 table-responsive">
										<table class="table table-striped">
											...
											<tr>
												...
												<td><button class="btn btn-default add-to-cart" onClick="AddToCart('.$pid.')"><i class="fa fa-shopping-cart"></i> Add to cart</button></td>
											</tr>
										</table>
									</div>
								';
